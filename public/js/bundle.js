...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJ1bmdodDE4MTAiLCJhIjoiY2tzd3l3ZjFmMTdyMDJ5czI2Z2tqc2tudCJ9.HQjSNP6cDA_wEH4COoqAnQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'Password' ? 'http://localhost:3001/api/v1/user/updateMyPassword' : 'http://localhost:3001/api/v1/user/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type, " is updated successfully!"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JVxqsGE0paLMBTwBSMGHbT9upUimYPgFFT80cf4GKfLdRkwpgeoZPuRv3MPfXiMo2bs0LGb5MQUNR20Nqd9p71z00eUCaFaAK');
            _context.next = 4;
...
var saveUpdateSettingBtn = document.querySelector('.btn--saveUpdate');
var updateSettingForm = document.querySelector('.form-user-data');
var saveUpdatePasswordBtn = document.querySelector('.btn--savepass');
...
if (updateSettingForm) {
  updateSettingForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return (0, _updateSetting.updateSetting)(data, 'Password');
